...
# we use Contract.from_adi here so we can support chains where multicall2 is not verified
multicall2 = _Contract.from_abi("Multicall2",MULTICALL2, MULTICALL2_ABI) if MULTICALL2 else None
