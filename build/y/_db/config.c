...
PyInit_config(void)
{
    ...
    PyObject *capsule = PyObject_GetAttrString(tmp, "init_y____db___config");
    Py_DECREF(tmp);
    if (capsule == NULL) return NULL;
    void *init_func = PyCapsule_GetPointer(capsule, "ypricemagic__mypyc.init_y____db___config");
    Py_DECREF(capsule);
    if (!init_func) {
        return NULL;
    }
...
PyMODINIT_FUNC PyInit___init__(void) { return PyInit_config(); }
