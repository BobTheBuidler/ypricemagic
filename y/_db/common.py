...
_metadata_read_executor = make_executor(2, 4, "ypricemagic Filter read metadata")
_metadata_write_executor = make_executor(1, 4, "ypricemagic Filter write metadata")
