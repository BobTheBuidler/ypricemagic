...
STABLECOINS = {
    Network.Mainnet: {
        ...
        "0x1456688345527bE1f37E9e627DA0837D6f08C925": "usdp-unit",
...
log_possible_recursion_err = logging.getLogger("ypricemagic.recursion_logger").__getattr__(recursion_logger_level)
